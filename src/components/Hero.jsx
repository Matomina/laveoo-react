        ...
        <section id="accueil" className="relative overflow-hidden bg-[#EAF2FB]" aria-labelledby="hero-title">
            ...
            <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
                <div className="mx-auto max-w-4xl text-center">
                    ...
                    <h1 id="hero-title" className="reveal-card mx-auto mt-5 max-w-4xl text-4xl font-black leading-[1.05] tracking-tight text-[#1F3A5F] sm:text-5xl lg:text-6xl">{hero.title}</h1>
                    <p className="reveal-card mx-auto mt-6 max-w-3xl text-base leading-8 text-[#595959] sm:text-lg">{hero.subtitle}</p>
                    ...
                    <div className="mt-8 flex flex-col gap-3 text-sm text-[#595959] sm:flex-row sm:flex-wrap sm:justify-center">
                        {hero.highlights.map((highlight) => <span key={highlight} className="reveal-card rounded-full border border-white/70 bg-white/80 px-4 py-2 font-medium shadow-sm">✓ {highlight}</span>)}
                    </div>
                </div>
            </div>
        </section>
